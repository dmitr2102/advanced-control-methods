...
= m l^2 \ddot{\theta} - m l \ddot{h} \sin \theta - m l \dot{h} \dot{\theta} \cos \theta.
$$
...
\ddot{\theta}
=
\left(\frac{g}{l}+\frac{\alpha}{l}\cos(\omega t)\right)\sin\theta
- d\dot{\theta}.
$$
...
\approx
-d\dot{\theta}
-\left(\frac{\alpha^2}{2l^2\omega^2}-\frac{g}{l}\right)\theta.
$$
...
\frac{1}{2}\dot{\theta}^2
+
\frac{\alpha^2}{4 l^2 \omega^2}\sin^2\theta
+
\frac{g}{l}(\cos\theta - 1).
$$
...
$$
\frac{\alpha(\theta)^2}{2 l^2 \omega^2} - \frac{g}{l}
=
k_0 + k_1 \theta^2.
$$
...
k_{\mathrm{eff}}
=
\frac{\alpha^2}{2l^2\omega^2}-\frac{g}{l}
$$
...
=
\frac12 \dot\theta^2 + k_p(1-\cos\theta).
$$
...
\frac12 e_2^2
+
\frac12\omega_\star^2 e_1^2
+
\frac12 k_o(r-r_\star)^2,
$$
...
\alpha_0
+
k_p E_{\mathrm{cycle},k}
+
k_d\frac{E_{\mathrm{cycle},k}-E_{\mathrm{cycle},k-1}}{T_c},
\qquad
a(t)=\alpha(t)\cos(\omega t).
$$
...
\ddot{\theta}
=
\frac{g+a}{l}\sin\theta - d\dot{\theta},
$$
...
a
=
-g - l k_p - l k_c \dot{\theta}\sin\theta
$$
...
\dot V_{\mathrm{dir}}
=
-\left(d + k_c \sin^2\theta\right)\dot{\theta}^2 \le 0.
$$
