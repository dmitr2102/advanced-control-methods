...
where $h$ is the horizontal position of the suspension point. The horizontal acceleration of the suspension point is chosen as the action
...
Let the suspension point move horizontally according to `h = h(t)`. The bob coordinates are
...
$$
\dot{X} = \dot{h} + l\dot{\theta}\cos\theta,
\qquad
...
v^2 = \dot{X}^2 + \dot{Z}^2
=
\dot{h}^2 + 2l\dot{h}\dot{\theta}\cos\theta + l^2\dot{\theta}^2.
$$
...
$$
l\ddot{\theta} + g\sin\theta + \ddot{h}\cos\theta = 0.
$$
...
\dot{s}_3 = a,
\qquad
\dot{s}_4 = -\frac{g}{l}\sin s_2 - \frac{a}{l}\cos s_2.
$$
